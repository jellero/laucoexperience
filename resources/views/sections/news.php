    ...
    <div class="container">
            ...
            <?php foreach ($eventiHome as $evento): ?>
                ...
                <div class="col-sm-6 single-news horizontal-news home-event-card">
                    <article>
                        ...
                        <a href="/evento?slug=<?= urlencode($evento['slug']) ?>" class="link" aria-label="<?= e($evento['titolo']) ?>"></a>
                    </article>
                </div>
            <?php endforeach; ?>
        </div>
        ...
        <?php if ($eventiHome): ?>
            <div class="col-md-12 text text-center padding-top-null">
                <a href="/eventi" class="btn-alt small margin-null active">Tutti gli eventi</a>
            </div>
        <?php endif; ?>
    </div>
</div>
