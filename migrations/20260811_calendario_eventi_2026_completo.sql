...
Organizzatore: Comune di Lauco.','assets/img/eventi/libro.png'),
...
Organizzatore: Casa del Popolo.','assets/img/eventi/festa-paese.png'),
  ('2026-05-03','autoemoteca-maggio-2026','Autoemoteca','Lauco','Eventi','Autoemoteca','Autoemoteca

Organizzatore: Donatori sangue Lauco/Buttea.','assets/img/eventi/autoemoteca.png'),
...
Organizzatore: Comune di Lauco / Casa del Popolo.','assets/img/eventi/teatro.png'),
...
Organizzatore: Parrocchia.','assets/img/eventi/celebrazione-religiosa.png'),
...
Organizzatore: Pro Vinaio Aps.','assets/img/eventi/chiosco.png'),
...
Organizzatore: Pro Vinaio Aps.','assets/img/eventi/festa-paese.png'),
...
Organizzatore: Gruppo volontari di Trava.','assets/img/eventi/festa-paese.png'),
...
Organizzatore: Comune di Lauco.','assets/img/eventi/celtic-fest.png'),
...
Organizzatore: Comune di Lauco.','assets/img/eventi/concerto-coro.png'),
...
Organizzatore: Gruppo Volontari di Trava.','assets/img/eventi/cinema.png'),
...
Organizzatore: A.S.D. Carnia Pistons.','assets/img/eventi/rally.png'),
...
Organizzatore: A.S.D. Lauco.','assets/img/eventi/festa-paese.png'),
...
Organizzatore: Gruppo Cidulârs Buttea.','assets/img/eventi/cidules.png'),
  ('2026-10-31','las-cidules-uerpa-2026','Las Cidules','Uerpa','Eventi','Las Cidules','Las Cidules

Organizzatore: Gruppo Cidulârs Vas, Uerpa e Pesmolet.','assets/img/eventi/cidules.png'),
...
Organizzatore: Comune di Lauco.','assets/img/eventi/natale.png'),
...
Organizzatore: Gruppo degli Auguri.','assets/img/eventi/natale.png'),
...
Organizzatore: Gruppo Avaglio.','assets/img/eventi/cidules.png'),
...
Organizzatore: Comune di Lauco.','assets/img/eventi/festa-paese.png');
...
Organizzatore: Parrocchia.',
  e.`cover_image` = 'assets/img/eventi/celebrazione-religiosa.png',
  e.`pubblicato` = 1
WHERE
