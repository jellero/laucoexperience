...
if (file_exists(__DIR__ . '/../inc/gpx-stats.php')) {
        ...
        <div class="col-md-12 padding-leftright-null">
                ...
                <?php foreach ($percorsiConsigliati as $percorso): ?>
                    ...
                    <div class="item col-md-6">
                        <div class="showcase-trek">
                            ...
                            <a href="percorso.php?slug=<?= urlencode($percorso['slug']) ?>" class="link" aria-label="<?= e($percorso['titolo']) ?>"></a>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
            ...
            <?php if ($percorsiConsigliati): ?>
                <div class="col-md-12 text text-center padding-top-null">
                    <a href="itinerari-piedi.php" class="btn-alt small margin-null">Itinerari a piedi</a>
                    <a href="itinerari-mtb.php" class="btn-alt small margin-null active">Itinerari MTB</a>
                </div>
            <?php endif; ?>
