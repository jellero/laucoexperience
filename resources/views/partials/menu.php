            ...
            <div id="menu-classic">
                <div class="menu-holder">
                    <ul>
                        ...
                        <!-- ITINERARI SPECIALI -->
                        <li>
                            <a href="/itinerari-speciali" class="<?= isCurrent(['itinerari-speciali.php']) ? 'active-item' : '' ?>">Speciali</a>
                        </li>
                        ...
                        <!-- LUOGHI -->
                        <li>
                            <a href="/luoghi" class="<?= isCurrent(['luoghi.php', 'luogo.php']) ? 'active-item' : '' ?>">Luoghi</a>
