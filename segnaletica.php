                            ...
                            <ul>
                                ...
                                <li class="submenu">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="segnaletica.php" class="active-item">Info segnaletica</a></li>
                                ...
                                <li class="submenu">
                                    ...
                                    <ul class="sub-menu">
                                        <li><a href="utma.php">UTMA</a></li>
                                        <li><a href="trail-cramars.php">Trail dai&nbsp;Cramârs</a></li>
                                        <li><a href="cronoradime.php">Cronoradime</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="submenu">
                                    ...
                                    <ul class="sub-menu">
                                        <li><a href="luoghi-celti.php">I Celti</a></li>
                                        <li><a href="luoghi-trava.php">Chiesette di Trava</a></li>
                                        <li><a href="luoghi-terrazza.php">Terrazza panoramica</a></li>
                                        <li><a href="luoghi-clap.php">Clap “Centenari”</a></li>
                                    </ul>
                                </li>
                ...
                <div class="row margin-leftright-null contact-strip">
                    <div class="container">
                        <div class="col-md-12 text text-center">
                            ...
                            <a href="contatti.php" class="btn-alt small white margin-null active shadow">Vai ai contatti</a>
                        </div>
                    </div>
                </div>
