    ...
    <div id="main-wrap" class="full-width">
        ...
        <div id="page-content" class="header-static">
            <div id="flexslider" class="fullpage-wrap small">
                <ul class="slides">
                    <li style="background-image:url(assets/img/trip4.jpg)">
                    ...
                    <div class="row padding-onlytop-md">
                        <div class="col-md-12">
                            ...
                            <div class="callout">
                                ...
                                <p>
                                    <a class="btn-alt small" href="contatti">Segnala un aggiornamento</a>
                                    <a class="btn-alt small active" href="itinerari">Scopri gli itinerari</a>
                                </p>
                            </div>
