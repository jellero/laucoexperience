...
<?php $tabLabels=['overview'=>'Riepilogo','volontari'=>'Volontari','gruppi'=>'Gruppi','chat'=>'Chat WhatsApp','attivita'=>'Planning','sentieri'=>'Stato sentieri'];foreach($allowedViews as $key):$label=$tabLabels[$key];?><a class="<?=$view===$key?'active':''?>" href="?view=<?=e($key)?>"><?=e($label)?><?php if($key==='chat'&&$summary['non_letti']>0):?> (<?=$summary['non_letti']?>)<?php endif;?></a><?php endforeach;?>
</nav>
