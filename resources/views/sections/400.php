                ...
                <ul class="slides">
                    <li style="background-image:url(assets/img/old.jpg)">
                        <div class="container text text-center">
                            <h1 class="white margin-bottom-small">PAGINA IN AGGIORNAMENTO</h1>
                    ...
                    <ol class="breadcrumb">
                        <li><a href="#">Home</a></li>
                        <li class="active">aggiornamento</li>
                    </ol>
                </ul>
            </div>
            <!--  END Slider  -->
                        ...
                        <div class="col-md-6 padding-leftright-null">
                            <div class="text">
                                ...
                                <div class="padding-onlytop-md">
                                    ...
                                    <p><span class="contact-info">Indirizzo <em>Via capoluogo 104
                                            Lauco</em></span><br><span class="contact-info">Telefono <em>+39 0433 74101</em></span><br><span class="contact-info">Email <a href="#"><em> comune.lauco@certgov.fvg.it</em></a></span></p>
                                    <p class="margin-md-bottom-null"><span class="contact-info">Lun Ven <em>9.00  12.00 </em></span><br><span class="contact-info"> <em></em></span></p>
                                </div>
                            </div>
                        </div>
                        <!--  END Contact Info -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="submit-area padding-onlytop-sm">
                                                <input type="submit" id="submit-contact" class="btn-alt" value="Invia">
